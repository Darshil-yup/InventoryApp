...
export default function ReceivingScreen() {
    ...
    const updateEntry = (index: number, field: keyof ReceivingEntry, value: any) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await apiClient.post('/api/receiving', {
                ...
                <ScrollView style={styles.content}>
                    <View style={styles.infoRow}>
                        <Card style={styles.infoCard}>
                            ...
                            <Text style={[styles.infoValue, { color: colors.textPrimary }]}>Receiving</Text>
                    ...
                    {selectedProject && (
                        <ProjectPartsViewer
                            ...
                            onEntriesChange={(newEntries) => {
                                setEntries(newEntries as ReceivingEntry[]);
                            }}
                            parts={parts}
                        />
                    )}
...
const styles = StyleSheet.create({
    ...
    entryCard: {
        borderLeftWidth: 4,
        borderLeftColor: COLORS.success, // Use Green for Receiving (coming in)
    },
    entryHeader: {
        flexDirection: 'row',
